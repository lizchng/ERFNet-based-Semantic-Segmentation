...
NUM_CHANNELS = 3
NUM_CLASSES = 9 #pascal=22, cityscapes=20
...
class MyCoTransform(object):
    ...
    def __call__(self, input, target):
        ...
        if(self.augment):
            ...
            target = ImageOps.expand(target, border=(transX,transY,0,0), fill=0) #pad label filling with 255
...
def train(args, model, enc=False):
    ...
    #create a loader to run all images and calculate histogram of labels, then create weight array using class balancing
    ...
    dataset_train = cityscapes(args.datadir, co_transform, args.savedir)
    dataset_val = cityscapes(args.datadir, co_transform_val, args.savedir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datadir', default="../dataset/Zhoushan/")
